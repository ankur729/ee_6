    ...
    .post('/save-attr-field-name', function (req, res, next) 
{
        ...
        var value=req.body.g_name;
            db.attribute_infos.find(
                ...
                {
                   'groupname.fields':req.body.g_name
    ...
    .post('/delete-selected-attr-field', function (req, res, next) {
        ...
        for (var i = 0; i < req.body.selected_attr_field.length; i++) {
            ...
            db.attribute_infos.update({
                            ...
                            'groupname.group_fields._id':mongojs.ObjectId( req.body.selected_attr_field[i])
                },
               {
                    '$pull': {
                        'groupname.$.group_fields': {

                            '_id':mongojs.ObjectId(req.body.selected_attr_field[i])
...
// });
         ...
         db.attribute_infos.find({
             ...
             'groupname.group_fields._id':mongojs.ObjectId(req.body.attr_id)

         },
         {'groupname.$.group_fields':1}
         , function (err, data, lastErrorObject) {
            if (err) {
                res.status(400);
                res.send('error');
